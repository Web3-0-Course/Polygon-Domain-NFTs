...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Sarkar Name Service","SNS"){
        tld = _tld;
    ...
    function register(string calldata name) public payable {
        ...
        // Create the JSON metadata of our NFT. We do this by combining strings and encoding
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name":"', 
                _name,
                '", "description": "A domain on the Sarkar name Service", "image" : "data:image/svg+xml;base64,',
    ...
    function setRecord(string calldata name, string calldata record) public {
        ...
        require(domains[name] == msg.sender,"Domain does not belong to this address");
        records[name] = record;
    }
